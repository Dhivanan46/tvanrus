...
let products = [
    {
        ...
        name: "Hoodies",
        price: 15.00,
        image: "./assets/img/hoodie/ai_red_hoodie.png",
        category: "hoodies",
        stock: 46,
    },
    {
        ...
        name: "Shirts",
        price: 10,
        image: "./assets/img/tshirt/white_red_v.png",
        category: "shirts",
        stock: 102,
    },
    {
        ...
        price: 26.00,
        image: "./assets/img/venom/ai_venom.png",
        category: "venom-collection",
        stock: 96,
    },
    // Duplicated Hoodies
    {
        ...
        name: "Hoodies",
        price: 17.00,
        image: "./assets/img/hoodie/ai_navy_hoodie.png",
        category: "hoodies",
        stock: 40,
    },
    {
        ...
        name: "Hoodies",
        price: 12.00,
        image: "./assets/img/hoodie/green_hoodie.png",
        category: "hoodies",
        stock: 32,
    },
    {
        ...
        name: "Hoodies",
        price: 13.00,
        image: "./assets/img/hoodie/ai_brown_hoodie.png",
        category: "hoodies",
        stock: 26,
    },
    // Duplicated Shirts
    {
        ...
        name: "Shirts",
        price: 15.00,
        image: "./assets/img/tshirt/red_black_colar.png",
        category: "shirts",
        stock: 84,
    },
    {
        ...
        name: "Shirts",
        price: 12.00,
        image: "./assets/img/tshirt/blue_t.png",
        category: "shirts",
        stock: 73,
    },
    {
        ...
        name: "Shirts",
        price: 10.00,
        image: "./assets/img/tshirt/white_black_v.png",
        category: "shirts",
        stock: 64,
    },
    {
        ...
        name: "Shirts",
        price: 10.00,
        image: "./assets/img/tshirt/brown_t.png",
        category: "shirts",
        stock: 27,
    },
    // Duplicated Venom Collection
    {
        id: 11,
        name: "Venom Collection",
        price: 20.00,
        image: "./assets/img/venom/venom3.png",
        category: "venom-collection",
        stock: 100,
    },
    {
        ...
        name: "Venom Collection",
        price: 24.00,
        image: "./assets/img/venom/veom.png",
        category: "venom-collection",
        stock: 98,
    },
];

//Menu All/hoodies/shirts/venom-collection
...
productShow.addEventListener("click", (e) => {
    ...
    if(e.target.classList.contains("products__title") || e.target.classList.contains("products__stock")){
        ...
        if(showWhat === ".hoodies"){
            productContainer.innerHTML = "";
            printWearsByCategory("hoodies");
        }
        if(showWhat === ".shirts"){
            productContainer.innerHTML = "";
            printWearsByCategory("shirts");
        }
        if(showWhat === ".venom-collection"){
            productContainer.innerHTML = "";
            printWearsByCategory("venom-collection");
        }
    }
...
function printWears(){
    ...
    const shirts = products.filter(product => product.category === "shirts").slice(0, 5);
    const venomCollections = products.filter(product => product.category === "venom-collection").slice(0, 3);
    const allProducts = [...hoodies, ...shirts, ...venomCollections];
...
function printWearsByCategory(category){
    let html = "";
